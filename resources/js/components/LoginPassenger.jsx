    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (response.data.user.role !== 'passenger') {
                setError('Este usuario no es un pasajero. Por favor use el login correcto.');
                setLoading(false);
                return;
            }

            localStorage.setItem('passenger_token', response.data.access_token);
            localStorage.setItem('passenger_role', response.data.user.role);
            localStorage.setItem('passenger_user', JSON.stringify(response.data.user));
