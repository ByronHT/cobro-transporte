<x-app-layout>
    <div class="py-6 max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <form method="POST" action="{{ route('admin.rutas.update', $ruta->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre', $ruta->nombre) }}" required placeholder="Ej: Línea 1"
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="linea_numero" value="{{ old('linea_numero', $ruta->linea_numero) }}" maxlength="50" placeholder="Ej: 10, 12A, Micro A"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="descripcion" rows="2"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('descripcion', $ruta->descripcion) }}</textarea>
                </div>
                ...
                <div class="mb-6 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-lg">
                    ...
                    <textarea name="ruta_ida_descripcion" rows="3" placeholder="Ej: Terminal - Plaza - Centro - Universidad"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('ruta_ida_descripcion', $ruta->ruta_ida_descripcion) }}</textarea>
                </div>
                ...
                <div class="mb-6 p-4 bg-green-50 border-l-4 border-green-500 rounded-lg">
                    ...
                    <textarea name="ruta_vuelta_descripcion" rows="3" placeholder="Ej: Universidad - Centro - Plaza - Terminal"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('ruta_vuelta_descripcion', $ruta->ruta_vuelta_descripcion) }}</textarea>
                </div>
                ...
                <div class="mb-6 grid sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="number" name="tarifa_base" step="0.01" min="0" value="{{ old('tarifa_base', $ruta->tarifa_base) }}" required
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Tarifa Adulto (Bs.)</label>
                        <input type="number" name="tarifa_adulto" step="0.01" min="0" value="{{ old('tarifa_adulto', $ruta->tarifa_adulto) }}" required
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-bold text-gray-700 mb-2">Tarifa con Descuento (Bs.)</label>
                        <input type="number" name="tarifa_descuento" step="0.01" min="0" value="{{ old('tarifa_descuento', $ruta->tarifa_descuento) }}" required
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="mb-6 flex items-center gap-3">
                    <input id="activa" type="checkbox" name="activa" value="1" {{ old('activa', $ruta->activa) ? 'checked' : '' }}
