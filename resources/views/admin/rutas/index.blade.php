                            ...
                            <tr class="hover:bg-blue-50">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div>
                                            ...
                                            <div class="text-xs text-gray-500">ID: {{ $ruta->id }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-700">{{ Str::limit($ruta->descripcion, 50) ?? '-' }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('admin.rutas.edit', $ruta->id) }}" class="text-yellow-600 hover:text-yellow-900">
                                            Editar
                                        </a>
                                        <form action="{{ route('admin.rutas.destroy', $ruta->id) }}" method="POST" onsubmit="return confirm('¿Está seguro?');">
                                            @csrf
                                            @method('DELETE')
