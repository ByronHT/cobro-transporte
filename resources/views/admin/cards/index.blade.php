                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th class="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">UID Tarjeta</th>
                            ...
                            <tr class="hover:bg-blue-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-mono font-bold text-gray-900">{{ $card->uid }}</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-bold text-gray-900">Bs. {{ number_format($card->balance, 2) }}</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @if($card->passenger)
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-sm font-medium text-gray-900">{{ $card->passenger->name }}</span>
                                        </div>
                                    @else
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <form action="{{ route('admin.cards.destroy', $card->id) }}" method="POST"
                                              onsubmit="return confirm('¿Está seguro de eliminar esta tarjeta?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
